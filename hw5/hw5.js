...
import { SquarePyramid } from '../hw5/squarePyramid.js';
...
function render() {
    ...
    let camY = (cameraCircleHeight/2)*Math.sin(glMatrix.toRadian(cameraHeightSpeed * elapsedTime))+(cameraCircleHeight/2);
